...
const partners = [
  { name: 'LayerZero', description: 'Interoperability protocol.', logoUrl: 'https://cryptologos.cc/logos/layerzero-zro-logo.svg', dataAiHint: 'abstract logo' },
  { name: 'Pyth', description: 'Decentralized oracle network.', logoUrl: 'https://cryptologos.cc/logos/pyth-network-pyth-logo.svg', dataAiHint: 'abstract logo' },
  { name: 'Den SAFE', description: 'Multi-sig solutions.', logoUrl: 'https://cryptologos.cc/logos/safe-safe-logo.svg', dataAiHint: 'abstract logo' },
  { name: 'Quicknode', description: 'High-performance RPC nodes.', logoUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-quicknode-10128537-8208479.png', dataAiHint: 'abstract logo' },
  { name: 'Goldsky', description: 'Real-time data indexing.', logoUrl: 'https://goldsky.com/_next/image?url=%2Fimages%2Fgoldsky-logo-white-wordmark.svg&w=3840&q=75', dataAiHint: 'abstract logo' },
  { name: 'Chainstack', description: 'Enterprise-grade RPC services.', logoUrl: 'https://chainstack.com/wp-content/uploads/2022/05/chainstack-logo-white.svg', dataAiHint: 'abstract logo' },
]
